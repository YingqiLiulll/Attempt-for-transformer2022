...
class WindowAttention(nn.Module):
    ...
    def attn_init(self, ):
        if self.attn_type == 'vanilla':
            ...
            self.w_1 = nn.Linear(self.dim // self.num_heads, 10)  # 由原始input的维度d_k到中间一层的维度d_hid1
            self.w_2 = nn.Linear(10, 1)  # 由原始input的维度d_k到中间的维度d_hid
            self.w_3 = nn.Linear(1, 64)  # 由原始input的维度d_k到中间的维度d_hid
            self.relu = nn.ReLU()
